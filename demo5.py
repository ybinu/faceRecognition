...
imgdir = "./"
# Load a sample picture and learn how to recognize it. 奥巴马
...
def frame_mark(frame):
    ...
    for face_landmarks in face_landmarks_list:
        ...
        #鼻梁
        point_color = (11, 53, 89) #RGB
        for point in face_landmarks['nose_bridge']:
            cv2.circle(frame, point, point_size, point_color, thickness)
      
        #鼻尖
        point_color = (150, 150, 0) #RGB
